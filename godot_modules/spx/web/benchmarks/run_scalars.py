...
FUNCTIONS = ["physics_set_global_gravity", "camera_set_camera_smoothing",
             ...
             "camera_set_camera_limit", "sprite_set_z_index", "sprite_check_collision"]
...
def main():
    ...
    parser.add_argument("--baseline", default="f497756e54", help="Git revision before the int64 input simplification")
