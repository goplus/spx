...
package embeddedpkgs

//go:generate go run ../cmd/qexpwrap -outdir pkg github.com/goplus/spx/v2
//go:generate go run ../cmd/qexpwrap -outdir pkg github.com/goplus/spx/v2/pkg/spx/pkg/engine
//go:generate go run ../cmd/qexpwrap -outdir pkg github.com/goplus/spx/v2/pkg/spx

// Shared ixgo package registrations used by gengo and ispx.
import (
	// Stdlib packages.
	...
	_ "github.com/goplus/spx/v2/internal/embeddedpkgs/pkg/github.com/goplus/spx/v2"
	_ "github.com/goplus/spx/v2/internal/embeddedpkgs/pkg/github.com/goplus/spx/v2/pkg/spx"
	_ "github.com/goplus/spx/v2/internal/embeddedpkgs/pkg/github.com/goplus/spx/v2/pkg/spx/pkg/engine"
)
