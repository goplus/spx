...
func VerifyZip(zipPath string, options ...VerifyOptions) (Bundle, error) {
	...
	if len(options) > 1 {
		return Bundle{}, fmt.Errorf("runtimebundle: VerifyZip accepts at most one options value")
	}
	if len(options) == 1 {
		opts = options[0]
	}
...
// VerifyZIP is retained as an all-caps spelling for callers that use ZIP in
// API names.
func VerifyZIP(zipPath string, options ...VerifyOptions) (Bundle, error) {
	return VerifyZip(zipPath, options...)
}
...
func VerifyZipReader(reader io.ReaderAt, size int64, options ...VerifyOptions) (Bundle, error) {
	var opts VerifyOptions
	if len(options) > 1 {
		return Bundle{}, fmt.Errorf("runtimebundle: VerifyZipReader accepts at most one options value")
	}
	if len(options) == 1 {
		opts = options[0]
	}
...
// Verify is a short alias for VerifyZipReader.
func Verify(reader io.ReaderAt, size int64, options ...VerifyOptions) (Bundle, error) {
	return VerifyZipReader(reader, size, options...)
}
...
func ExtractZip(zipPath, dst string, options ...VerifyOptions) (Bundle, error) {
	var opts VerifyOptions
	if len(options) > 1 {
		return Bundle{}, fmt.Errorf("runtimebundle: ExtractZip accepts at most one options value")
	}
	if len(options) == 1 {
		opts = options[0]
	}
...
func ExtractZipReader(reader io.ReaderAt, size int64, dst string, options ...VerifyOptions) (Bundle, error) {
	var opts VerifyOptions
	if len(options) > 1 {
		return Bundle{}, fmt.Errorf("runtimebundle: ExtractZipReader accepts at most one options value")
	}
	if len(options) == 1 {
		opts = options[0]
	}
