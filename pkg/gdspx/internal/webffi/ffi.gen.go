...
type GDExtensionInterface struct {
	...
	SpxSpriteBatchUpdatePositions               js.Value
...
func (x *GDExtensionInterface) loadProcAddresses() {
	...
	x.SpxPhysicsRaycast = dlsymGD("gdspx_physics_raycast")
	x.SpxPhysicsCheckCollision = dlsymGD("gdspx_physics_check_collision")
	...
	x.SpxPhysicsSetGlobalFriction = dlsymGD("gdspx_physics_set_global_friction")
	x.SpxPhysicsGetGlobalFriction = dlsymGD("gdspx_physics_get_global_friction")
	x.SpxPhysicsSetGlobalAirDrag = dlsymGD("gdspx_physics_set_global_air_drag")
	x.SpxPhysicsGetGlobalAirDrag = dlsymGD("gdspx_physics_get_global_air_drag")
	x.SpxPhysicsCheckCollisionRect = dlsymGD("gdspx_physics_check_collision_rect")
	x.SpxPhysicsCheckCollisionCircle = dlsymGD("gdspx_physics_check_collision_circle")
	x.SpxPhysicsRaycastWithDetails = dlsymGD("gdspx_physics_raycast_with_details")
	...
	x.SpxSpriteBatchUpdatePositions = dlsymGD("gdspx_sprite_batch_update_positions")
