...
type GDExtensionInterface struct {
	...
	SpxPhysicCheckNearestTouchedCameraBoundary js.Value
...
func (x *GDExtensionInterface) loadProcAddresses() {
	...
	x.SpxPhysicCheckNearestTouchedCameraBoundary = dlsymGD("gdspx_physic_check_nearest_touched_camera_boundary")
